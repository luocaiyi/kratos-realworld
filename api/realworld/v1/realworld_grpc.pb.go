...
type RealWorldClient interface {
	Authentication(ctx context.Context, in *AuthenticationRequest, opts ...grpc.CallOption) (*UserReply, error)
...
func (c *realWorldClient) Authentication(ctx context.Context, in *AuthenticationRequest, opts ...grpc.CallOption) (*UserReply, error) {
	out := new(UserReply)
	err := c.cc.Invoke(ctx, "/realworld.v1.RealWorld/Authentication", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RealWorldServer interface {
	Authentication(context.Context, *AuthenticationRequest) (*UserReply, error)
...
func (UnimplementedRealWorldServer) Authentication(context.Context, *AuthenticationRequest) (*UserReply, error) {
...
func _RealWorld_Authentication_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AuthenticationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RealWorldServer).Authentication(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/realworld.v1.RealWorld/Authentication",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RealWorldServer).Authentication(ctx, req.(*AuthenticationRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _RealWorld_Authentication_Handler,
		},
		{
